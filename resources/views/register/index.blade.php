...
<head>
    ...
    <title>TokoMarket - Register</title>
                        ...
                        <div class="p-5">
                            ...
                            <form action="{{route('register.store')}}" method="POST" class="user">
                                ...
                                <div class="form-group row">
                                    <input type="text" class="form-control form-control-user" name="name" placeholder="Masukan Nama" value="{{@old('name')}}">
                                </div>
                                @error('email')
                                    <span class="text-danger">{{ $massage }}</span>
                                @enderror
                                <div class="form-group row">
                                    <input type="email" class="form-control form-control-user" name="email" placeholder="Masukan Email" value="{{@old('email')}}">
                                </div>
                                @error('password')
                                    <span class="text-danger">{{ $massage }}</span>
                                @enderror
